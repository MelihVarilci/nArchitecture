...
public class TokenOptions
{
    ...
    /*
     * Login olunduğunda, hali hazırda olan aktif reflesh token yeterince eskiyse (oluşturulma tarihine eklenmiş TTL süresine göre) silinerek oturum sonlandırılır.
